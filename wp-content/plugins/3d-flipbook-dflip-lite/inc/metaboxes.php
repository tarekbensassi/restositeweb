...
class DFlip_Meta_boxes
{
  ...
  public function create_meta_boxes_limit( $post )
  {
    ...
    <a href="https://1.envato.market/DmQ7o" target="_blank">Buy Full Version</a>
    <a href="https://chrome.google.com/webstore/detail/pdf-viewer-pdf-flipbook-d/bbbnbmpdkfkndckfmcndgabefnmdedfp/?page=lite-post" target="_blank">Get FREE Flipbook extension for Chrome</a>
    <?php
  ...
  public function create_meta_boxes_video( $post )
  {
    ...
    if ( $current_screen->post_type == 'dflip' ) {
      ...
      http://flipbookplugin.com/docs/wordpress/index.html" target="_blank"><span class="dashicons dashicons-book"></span>Live Documentation</a>
        </li>
        <li>
          <a class="video-tutorial df-chrome" href="https://chrome.google.com/webstore/detail/pdf-viewer-pdf-flipbook-d/bbbnbmpdkfkndckfmcndgabefnmdedfp/?page=lite-post" target="_blank">FREE Flipbook for Chrome</a>
        </li>
      </ul>
      <?php
    }
