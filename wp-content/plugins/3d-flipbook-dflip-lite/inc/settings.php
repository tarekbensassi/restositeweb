...
class DFlip_Settings {
  ...
  public function settings_page() {
    ...
    <h2><?php echo esc_html( get_admin_page_title() ); ?> <a href="https://1.envato.market/DmQ7o" target="_blank">Buy Full Version</a></h2>
    
    <form id="dflip-settings" method="post" class="dflip-settings premium postbox">
      
      <?php
      wp_nonce_field( 'dflip_settings_nonce', 'dflip_settings_nonce' );
      submit_button( __( 'Update Settings (Premium)', 'DFLIP' ), 'primary', 'dflip_settings_submit', false );
      ?>
  ...
  public function updated_settings() {
      ?>
      <div class="error">
        <p><?php _e( 'Settings can be saved only in Premium Version updated.', 'DFLIP' ); ?> <a
                  href="https://1.envato.market/DmQ7o" target="_blank">Buy Full Version</a></p>
      </div>
      <?php
  }
