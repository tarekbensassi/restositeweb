...
add_action( 'wp_ajax_r3d_duplicate', 'r3d_duplicate_callback' );
add_action( 'wp_ajax_nopriv_r3d_duplicate', 'r3d_duplicate_callback' );

function r3d_duplicate_callback() {
...
add_action( 'wp_ajax_r3d_delete', 'r3d_delete_callback' );
add_action( 'wp_ajax_nopriv_r3d_delete', 'r3d_delete_callback' );

function r3d_delete_callback() {
